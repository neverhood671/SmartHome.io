...
function initPopup() {
    Array.from(document.querySelectorAll(".device_card")).forEach(e => {
        e.addEventListener("click", e => {
            ...
            let t = document.querySelector(".popup_window"), r = parseInt(e.currentTarget.firstChild.dataset.value);
            t.insertAdjacentHTML("afterBegin", e.currentTarget.innerHTML), document.querySelector(".slider").value = r, 
